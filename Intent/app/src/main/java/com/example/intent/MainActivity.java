    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_move_activity_data:
                ...
                moveWithDataIntent.putExtra("extra_name", "Naufal Mahdi Rahman Ubaid");
                moveWithDataIntent.putExtra("NIM", "E41191445");
            ...
            case R.id.btn_dial_a_number:
                String phoneNumber = "081217938987";
            ...
            case R.id.btn_share_text:
                ...
                share.putExtra(Intent.EXTRA_TEXT, "Belajar Android ");
                share.setType("text/plain");
                startActivity(Intent.createChooser(share, "share link"));
                break;
            case R.id.btn_sms:
                Intent sms = new Intent(Intent.ACTION_SENDTO, Uri.parse("smsto: 081217938987"));
